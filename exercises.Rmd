...
```{r}
inputPanel(
  selectInput("attribute", label = "Select attribute:",
              choices = c('population', 'museums', 'castles', 'attractions'), selected = 'population')
...
renderTmap({
  tm_shape(attractions_salzburg) +
  tm_polygons(col = input$attribute, style = 'jenks') 
})
