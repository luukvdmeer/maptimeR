...
* population: https://www.salzburg.gv.at/ogd/f3148c9c-4e14-4258-b00f-b7695b75d480/population-szg-sex-age-city.csv
...
attractions_salzburg = attractions_salzburg %>% 
  mutate(attractions = castles + museums) %>% 
  mutate(area = st_area(geometry))

attractions_salzburg = attractions_salzburg %>% mutate(attractions_density = attractions/area)
```

# Visualize data

```{r}
# This is base R plotting. A simple scatterplot can be created with one line. Try changing the variables!
plot(attractions ~ population, data = attractions_salzburg)
...
# Which we can easily make interactive with the plotly package
